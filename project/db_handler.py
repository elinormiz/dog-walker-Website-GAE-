...
#-------------------------------------------------------------------------
# Author:       Tal Zohar, Elinor Mizrachi, Matan Porcilan
...
DB_USER_NAME='project02'
DB_PASSWORD='iekzbnqy'
DB_DEFALUT_DB='project02'
#create a class to connect and work with the database
class DbHandler():
	def __init__(self):
